    ...
    /** @lends com.zespri.awct.collab.view.DeliverySwapCreate */
    {
            ...
            switch (sSelectedFilterListKey) {
                case "SourceDeliveryNumber" :
                    ...
                    if (sSelectedSourceShipment) {
                        ...
                        com.zespri.awct.utfil.ModelHelper.getJSONModelForRead("/DeliveryHeaderSet", {
                            urlParameters : {
                ...
                case "TargetDeliveryNumber" :
                    ...
                    var fnDeliveryListReadSuccess = function(oJSONModel) {
                        // Success
                        oController._bindResultOnSuccess(oJSONModel, oSource);
                        oSource.setBusy(false);
                    };
                    if (sSelectedTargetShipment) {
                        ...
                        }, fnDeliveryListReadSuccess);
                    } else {
                        com.zespri.awct.util.ModelHelper.getJSONModelForRead("/DeliveryHeaderSet", {}, fnDeliveryListReadSuccess);
                    }
                    break;
            }
        },
        ...
        _createTableColumnListItem : function(sId, oContext) {
            ...
            if (oContext.getProperty("RecordType") === this._DeliverySwapRecordType.DeliveryLine) {
                oTableListItem = sap.ui.xmlfragment(sId, "com.zespri.awct.collab.fragment.DeliverySwapDeliveryLineTemplate", this).setBindingContext(
                        oContext);
            } else {
                oTableListItem = sap.ui.xmlfragment(sId, "com.zespri.awct.collab.fragment.DeliverySwapAllocationLineTemplate", this)

                            ...
                            var fnBatchReadSuccess = function(oData, oResponse, aErrorResponses) {
                               ...
                               $batchReadDeferred.resolve();
                                ...
                                if (oController._sViewStatus === com.zespri.awct.util.Enums.ViewMode.Add) {
                                    ...
                                    // Edit
                                    /*
                                     * Check the incoming Route. This part is tricky. If the user reached this view from the 'ExceptionRateMaintenance'
                                     * view, the details about the current exception rate record will already be available in the model and
                                     ...
                                     * the current exception rate record from the backend, using the context path available in the URL.
                                     */

                                    // show delete button
                                    oController.byId('deleteExceptionRateButton').setVisible(true);
                                    oController._oExceptionRateContext = new sap.ui.model.Context(oController.getView().getModel(), '/' + sContextPath);
